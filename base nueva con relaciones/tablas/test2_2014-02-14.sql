...
# Base de datos: test2
# Tiempo de Generación: 2014-02-14 15:03:23 +0000
# ************************************************************
...
LOCK TABLES `afip_relaciones` WRITE;
/*!40000 ALTER TABLE `afip_relaciones` DISABLE KEYS */;

INSERT INTO `afip_relaciones` (`cuit`, `cuil`, `apellido_nombre`, `fecha_inicio_relacion`, `fecha_fin_relacion`, `renos`, `clave_alta_registro`, `fecha_clave_registro`, `separador`, `hora_clave_alta`, `clave_baja_registro`, `fecha_clave_baja`, `separor2`, `hora_clave_baja`, `codigo_contrato`, `marca_trabajador_agro`, `regimen_aportes`, `codigo_sit_baja`, `filler1`, `fecha_mov`, `separador3`, `hora_mov`, `codigo_mov`, `rem_bruta`, `cod_modalidad_liq`, `cod_sucursal_exp`, `cod_actividad`, `cod_puesto`, `fecha_telegrama_renuncia`, `filler2`, `marca_rectificacion`, `area_reservada`, `id`)
VALUES
...
/*!40000 ALTER TABLE `afip_relaciones` ENABLE KEYS */;
UNLOCK TABLES;
